 ...
 * was running at the time (ADR-0001) — so a rename must carry it across rather
 ...
 * it costs no tokens and no Allowance of its own (ADR-0002). Any failure yields
 * no sample at all — an expired token, a changed response, no network — because
 * a blank Allowance is correct and a guessed one is not (ADR-0001).
 */
