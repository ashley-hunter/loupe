// The domain model. Terms here are the ones defined in CONTEXT.md; if you rename
// something, rename it there too.
...
export interface SessionSummary {
   ...
   * Session that ended before the app was installed — see ADR-0001. Never
   * estimated, and never summed across Sessions when `allowanceShared` is set.
   */
